class Frankenphp < Formula
  ...
  url "https://github.com/php/frankenphp/archive/refs/tags/v1.12.7.tar.gz"
  sha256 "4f8636315cc3748df02a27f36b3456b96eaebf505029e26dbd5fb473896d94c5"
  license "MIT"
  head "https://github.com/dunglas/frankenphp.git", branch: "main"

  bottle do
    root_url "https://ghcr.io/v2/dunglas/frankenphp"
    sha256 cellar: :any, arm64_sequoia: "da12f45b79f54640b47bed59c2dd39a4a5b9bea02d1b7faf65f904804634e9f1"
    sha256 cellar: :any, x86_64_linux:  "6d39657fe3b699787ab2838cd1099813e2dbf8327c1d07a8e04db98fc9108ed3"
  end
